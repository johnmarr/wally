...
// This was a helper class I pulled from github.
// I did not create the class, but cleaned it up and tailored it to suit.
...
class GradientSlider: UIControl {
    ...
    public var hasRainbow:Bool  = false {didSet{updateTrackColors()}}
    public var minColor:UIColor = UIColor.blue {didSet{updateTrackColors()}}
    public var maxColor:UIColor = UIColor.orange {didSet{updateTrackColors()}}
